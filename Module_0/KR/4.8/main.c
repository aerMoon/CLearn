/*
 * Упражнение 4.8. Предположим, что число символов, возвращаемых назад, не превышает 1. Модифицируйте с учетом этого
 * факта функции getch и ungetch.
 *
 * p.s. Ошибка перевода???? getch и ungetch уже были написаны с учётом этого 0_о
 *
 */
